package com.biscoitodasorte.ui.components
...
import com.biscoitodasorte.data.Phrase
...
fun PhraseContainer(modifier: Modifier, selectedPhrase: Phrase){
    ...
    val sharePhrase: ()->Unit = {
        val customSharePhraseContent = "${selectedPhrase.content}\n\nBiscoito da Sorte: https://play.google.com/store/apps/details?id=com.br.biscoitodasorte"
